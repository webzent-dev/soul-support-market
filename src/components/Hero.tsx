      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        <div className="animate-fade-in">
          <h1 className="text-5xl md:text-7xl font-bold text-gray-800 mb-6 leading-tight">
            Winnipeg
            <span className="text-purple-600"> Healing Connection</span>
          </h1>
          
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            Connect with trusted mental health professionals, healing practitioners, and community events. 
            Your journey to wellness starts here in Winnipeg.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Button size="lg" className="bg-purple-600 hover:bg-purple-700 text-white px-8 py-3 rounded-full text-lg transition-all duration-300 hover:scale-105">
              <Users className="mr-2 h-5 w-5" />
              Join Our Community
            </Button>
            <Button variant="outline" size="lg" className="border-purple-600 text-purple-700 hover:bg-purple-50 px-8 py-3 rounded-full text-lg transition-all duration-300 hover:scale-105">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
              ...
              <p className="text-gray-600">Find trusted mental health professionals and healing practitioners in Winnipeg</p>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
              ...
              <p className="text-gray-600">Join healing workshops, support groups, and wellness events in your city</p>
            </div>
